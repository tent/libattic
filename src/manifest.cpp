...
bool Manifest::CreateInfoTable() {
    std::cout << " Creating info table ... " << std::endl;
    std::string exc;
...
bool Manifest::CreateFolderTable() {
    std::cout<< " Creating folder table ... " << std::endl;
    std::string exc;
    exc += "CREATE TABLE IF NOT EXISTS ";
    exc += g_foldertable;
...
bool Manifest::UpdateFolderDeleted(const std::string& folderpath, bool del) {
