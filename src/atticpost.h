...
public:
    ...
    const std::string& master_key_iv() const    { return master_key_iv_; }
    ...
    const std::string& recovery_master_key_iv() const   { return recovery_master_key_iv_; }
    ...
    const std::string& question_master_key_iv() const   { return question_master_key_iv_; }
    ...
    void set_master_key_iv(const std::string& iv)   { master_key_iv_ = iv; }
    ...
    void set_recovery_master_key_iv(const std::string& iv)  { recovery_master_key_iv_ = iv; }
    ...
    void set_question_master_key_iv(const std::string& iv)  { question_master_key_iv_ = iv; }
private:
    std::string salt_;
    std::string master_key_;
    std::string master_key_iv_;

    std::string recovery_salt_;
    std::string recovery_master_key_;
    std::string recovery_master_key_iv_;

    std::string question_salt_;
    std::string question_master_key_;
    std::string question_master_key_iv_;
